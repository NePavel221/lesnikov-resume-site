(function () {
  ...
  const AI_VARIANTS = {
    1: {
      title: 'AI-assisted разработка и автоматизация процессов',
      bullets: [
        'Около <strong>1500+ часов</strong> практики в разработке с помощью нейросетей',
        'Изучал, как собирать рабочие приложения, интерфейсы и внутренние инструменты под конкретную задачу',
        'Сфокусировался не на “болтовне про AI”, а на прикладной пользе: автоматизация рутины, упрощение процессов',
        'Прокачал навык превращать идею в понятный инструмент, удобный для ежедневной работы'
      ]
    },
    2: {
      title: 'Разработка с помощью нейросетей и прикладная автоматизация',
      bullets: [
        'Около <strong>1500+ часов</strong> практики в AI-assisted разработке',
        'Изучал, как быстро собирать интерфейсы, приложения и небольшие инструменты под рабочие задачи',
        'Использовал нейросети как рабочий инструмент, а не как развлечение: для ускорения рутины и прототипирования',
        'Научился превращать идею в понятное решение, которым можно пользоваться каждый день'
      ]
    },
    3: {
      title: '11 месяцев в AI-assisted разработке и сборке полезных инструментов',
      bullets: [
        'За этот период посвятил около <strong>1500+ часов</strong> практике разработки с помощью нейросетей',
        'Разбирался, как проектировать интерфейсы и собирать внутренние приложения без лишней бюрократии и долгой разработки',
        'Сфокусировался на прикладной пользе: калькуляторы, автоматизация, упрощение повторяющихся процессов',
        'Получил навык быстро собирать понятные решения под конкретную рабочую задачу'
      ]
    },
    4: {
      title: 'AI-assisted разработка как прикладной навык для бизнеса',
      bullets: [
        'Около <strong>1500+ часов</strong> практики в разработке с помощью нейросетей',
        'Изучал не теорию, а то, как собирать инструменты, которые реально экономят время и снимают рутину',
        'Умею использовать AI для прототипирования, автоматизации и создания внутренних решений под задачу',
        'Этот навык усилил меня как e-commerce специалиста, потому что позволяет быстрее превращать идеи в работающие инструменты'
      ]
    },
    5: {
      title: 'Практика в AI-assisted разработке и создании рабочих mini-apps',
      bullets: [
        'Примерно <strong>1500+ часов</strong> ушло на практику разработки с помощью нейросетей',
        'Изучал, как собирать mini-apps, калькуляторы и интерфейсы под прикладные задачи',
        'Сфокусировался на том, чтобы не “играться с AI”, а использовать его для ускорения реальной работы',
        'Научился собирать понятные инструменты, которые помогают в операционке и аналитике'
      ]
    },
    6: {
      title: '1500+ часов практики в разработке с помощью нейросетей',
      bullets: [
        'С мая 2025 по апрель 2026 целенаправленно занимался AI-assisted разработкой',
        'Изучал, как превращать идею в рабочий интерфейс, калькулятор или внутренний инструмент',
        'Фокус был на прикладных решениях: автоматизация рутины, упрощение задач, быстрый запуск MVP',
        'В результате получил рабочий навык, который можно использовать внутри e-commerce и операционки'
      ]
    },
    7: {
      title: 'Изучал AI-assisted разработку и практиковал создание полезных приложений',
      bullets: [
        'Около <strong>1500+ часов</strong> практики в сборке приложений и интерфейсов с помощью нейросетей',
        'Разобрался, как быстро проектировать и собирать небольшие, но полезные рабочие инструменты',
        'Использовал этот период, чтобы усилить себя в автоматизации и ускорении ручных процессов',
        'Теперь могу не только видеть проблему, но и собрать под неё решение в виде понятного инструмента'
      ]
    },
    8: {
      title: 'AI-assisted разработка: от идеи до рабочего инструмента',
      bullets: [
        'За 11 месяцев посвятил около <strong>1500+ часов</strong> практике разработки с нейросетями',
        'Изучал, как из идеи собирать интерфейсы, калькуляторы и внутренние приложения под конкретную задачу',
        'Сосредоточился на прикладном результате: меньше ручной рутины, больше понятных инструментов',
        'Этот период дал мне навык быстро доводить концепт до MVP и рабочего прототипа'
      ]
    },
    9: {
      title: 'Освоил прикладную разработку с помощью нейросетей',
      bullets: [
        'Около <strong>1500+ часов</strong> ушло на практику и сборку собственных решений',
        'Изучал, как делать рабочие интерфейсы, внутренние сервисы и небольшие приложения под задачу',
        'Прокачал навык автоматизировать повторяющиеся процессы и упрощать сложные ручные действия',
        'В итоге получил не просто “интерес к AI”, а реальный рабочий навык, который можно применять в бизнесе'
      ]
    },
    10: {
      title: 'AI-assisted разработка и автоматизация как моё дополнительное конкурентное преимущество',
      bullets: [
        'За 11 месяцев набрал около <strong>1500+ часов</strong> практики в разработке с помощью нейросетей',
        'Изучал, как собирать приложения, интерфейсы и прикладные инструменты под реальные бизнес-задачи',
        'Фокус делал на полезности: автоматизация рутины, упрощение процессов, быстрый запуск решений',
        'Этот навык дополняет мой опыт в e-commerce и делает меня сильнее как специалиста по маркетплейсам'
      ]
    }
  };

  function initAiVariants() {
    const titleEl = document.querySelector('[data-ai-title]');
    const bulletEls = Array.from(document.querySelectorAll('[data-ai-bullet]'));
    const buttons = Array.from(document.querySelectorAll('[data-ai-variant]'));
    if (!titleEl || !bulletEls.length || !buttons.length) return;

    const applyVariant = (id) => {
      const variant = AI_VARIANTS[id] || AI_VARIANTS[1];
      titleEl.textContent = variant.title;
      bulletEls.forEach((el, index) => {
        el.innerHTML = variant.bullets[index] || '';
      });
      buttons.forEach((btn) => btn.classList.toggle('is-active', Number(btn.dataset.aiVariant) === id));
    };

    buttons.forEach((btn) => {
      btn.addEventListener('click', () => applyVariant(Number(btn.dataset.aiVariant)));
    });
